...
public class MaoFlicker : MonoBehaviour
{
	public GameObject GameObjectToShake;
	bool shaking = false;

	IEnumerator shakeGameObjectCOR(GameObject objectToShake, float totalShakeDuration, float decreasePoint, bool objectIs2D = true){
